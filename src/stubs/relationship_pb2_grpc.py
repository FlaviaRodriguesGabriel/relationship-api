...
from . import relationship_pb2 as relationship__pb2
...
class PartnershipService(object):
    ...
    def AddPartnership(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/stubs.relationship.PartnershipService/AddPartnership',
    ...
    def GetPartnership(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/stubs.relationship.PartnershipService/GetPartnership',
            relationship__pb2.BusinessPartnershipMessage.SerializeToString,
            relationship__pb2.BusinessPartnershipMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdatePartnership(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/stubs.relationship.PartnershipService/UpdatePartnership',
            relationship__pb2.BusinessPartnershipMessage.SerializeToString,
            relationship__pb2.BusinessPartnershipMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeletePartnership(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/stubs.relationship.PartnershipService/DeletePartnership',
            relationship__pb2.BusinessPartnershipMessage.SerializeToString,
            relationship__pb2.BusinessPartnershipMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
